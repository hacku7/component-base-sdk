...
import (
	...
	"github.com/hacku7/component-base-sdk/pkg/validation/field"
)
...
// Validate validates config for errors-base-sdk and returns an error (it can be casted to
// ValidationErrors, containing a list of errors-base-sdk inside). When error is printed as string, it will
// automatically contains the full list of validation errors-base-sdk.
func (v *Validator) Validate() field.ErrorList {
	...
	// collect human-readable errors-base-sdk
